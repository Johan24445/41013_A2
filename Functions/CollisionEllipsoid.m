classdef CollisionEllipsoid < handle
    ...
    methods 
        function self = CollisionEllipsoid(robot, centerPoints, radii)
            self.robot = robot;
        ...
        function collision = checkCollision(self, meshPoints)
            ...
            totalCollisionPoints = 0;  % Initialize total collision points counter
            ...
            for i = 1: size(tr,3)
                ...
                totalCollisionPoints = totalCollisionPoints + collisionPoints;
                if collisionPoints > 0
                    collision = 1;
                    break
                end
            end
               % Display the total number of collision points if a collision occurs
            if collision > 0
                fprintf('Collision detected: %d collision points.\n', totalCollisionPoints);
            end
